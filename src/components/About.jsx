    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        <motion.div
          ...
          className="lg:col-span-5 bg-white rounded-3xl p-8 border border-gray-100 shadow-sm flex flex-col items-center"
        >
          <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-gray-50 shadow-md mb-6 relative">
          ...
          <div className="w-full">
            <a
              ...
              className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-brand text-white font-medium hover:bg-brand-hover transition-colors shadow-sm"
            >
        ...
        >
          <div className="text-lg text-gray-600 leading-relaxed space-y-6 mb-10">
            <p>
